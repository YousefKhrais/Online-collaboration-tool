                        ...
                        <form method="post" action="{{ Route("student.profile.update") }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <input type="text" class="form-control" value="{{$student->description}}"
                                               name="description" placeholder="Student">
                                    </div>
                                </div>
                                <div class="row mb-3">
                                    <div class="col-sm-3">
                            ...
                            <div class="card-footer text-right">
                                ...
                                <a class="btn btn-danger" href="{{ Route('student.profile.index') }}">Cancel</a>
                            </div>
                        </form>
                    </div>
                </div>
