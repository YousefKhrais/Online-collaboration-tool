                ...
                <div class="col-12 bg-white p-0 px-3 py-3 mb-3">
                    <div class="d-flex flex-column align-items-center">
                        <img class="photo"
                             ...
                             alt="">
                        <p class="fw-bold h4 mt-3" >@{{student.name}}</p>
                        <p class="text-muted">@{{student.description}}</p>
                        <div class="d-flex ">
                            <a href="{{route("StudentEditProfile")}}" class="btn btn-primary follow me-2">
                                Edit Profile
                            </a>
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-12 bg-white px-3 mb-3 pb-3">
                    <div class="d-flex align-items-center justify-content-between border-bottom">
                        ...
                        <p class="py-2 text-muted">@{{student.name}}</p>
                    </div>
                    <div class="d-flex align-items-center justify-content-between border-bottom">
                        <p class="py-2">Email</p>
                        <p class="py-2 text-muted">@{{student.email}}</p>
                    </div>

                        <div v-if="student.phone" class="d-flex align-items-center justify-content-between border-bottom">
                            <p class="py-2">Phone</p>
                            <p class="py-2 text-muted">@{{student.phone}}</p>
                        </div>


                        <div v-if="student.mobile" class="d-flex align-items-center justify-content-between border-bottom">
                            <p class="py-2">Mobile</p>
                            <p class="py-2 text-muted">@{{student.mobile}}</p>
                        </div>


                        <div v-if="student.address" class="d-flex align-items-center justify-content-between">
                            <p class="py-2">Address</p>
                            <p class="py-2 text-muted"> @{{ student.address }}</p>
                        </div>
...
@section("scripts")
    ...
    <script src="{{asset("js/Student/StudentProfile.js")}}">
