...
(() => {
/*!******************************************!*\
  !*** ./resources/js/ChatRoom/manager.js ***!
  \******************************************/
var videoBox = document.getElementById("roomVideoPage"); // let
...
var app = new Vue({
  ...
  methods: {
    ...
    showIDE: function showIDE() {
      console.log("show video clicked");
      this.chatRoom.style.display = "none";
      this.drawingTool.style.display = "none";
      this.ide.style.display = "block";
    },
    showDrawingPane: function showDrawingPane() {
      this.chatRoom.style.display = "none";
